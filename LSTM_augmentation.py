...
# ------------------- TRAINING  -------------------
def train_model(train_csv, test_csv, num_epochs=60, batch_size=8, lr=0.001):
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        if acc > best_acc:
            ...
            torch.save(model.state_dict(), 'BEST_MODEL_BY_ACCURACY_LSTM_10fps_addnoise_balance.pth')
...
if __name__ == "__main__":
    model = train_model(
        train_csv="/media/public_data/temp/Phuong/fall_videos/GMDCSA24/LSTM/GMDCSA24_10fps_train_raw_augmented_balance.csv",
        test_csv="/media/public_data/temp/Phuong/fall_videos/GMDCSA24/LSTM/GMDCSA24_10fps_test_raw.csv",
        num_epochs=60,
        batch_size=8,
        lr=0.001
    )
    ...
    # Reload best model
    model.load_state_dict(torch.load('BEST_MODEL_BY_ACCURACY_LSTM_10fps_addnoise_balance.pth'))

    test_dataset = PoseDataset("/media/public_data/temp/Phuong/fall_videos/GMDCSA24/LSTM/GMDCSA24_10fps_test_raw.csv")
